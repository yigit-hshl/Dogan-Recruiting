      ...
      },
      {
        ...
        subcategories: [
          ...
          { title: 'Specialties (Selection)', roles: [
              { name: 'General Practice (Family Physicians)', description: 'Primary care for all ages, preventive medicine, chronic disease management, and patient care coordination.' },
              ...
              { name: 'Gynecology and Obstetrics', description: 'Comprehensive women\'s healthcare, obstetrics, reproductive medicine, and gynecologic oncology.' },
              { name: 'Pediatrics', description: 'Neonatology, developmental pediatrics, pediatric cardiology, and general child & adolescent medicine.' },
              { name: 'Radiology & Neuroradiology', description: 'Diagnostic imaging (CT, MRI, X-ray, Ultrasound), interventional radiology, and neuroradiology.' },
              { name: 'Neurology', description: 'Stroke medicine, epileptology, movement disorders, and neuromuscular diseases.' },
              { name: 'Psychiatry and Psychotherapy', description: 'General psychiatry, addiction medicine, psychotherapy, and child & adolescent psychiatry.' },
          ]},
        ],
      },
      {
      ...
      },
      {
        ...
        subcategories: [
          ...
          { title: 'Fachrichtungen (Auswahl)', roles: [
              { name: 'Allgemeinmedizin (Hausärzte)', description: 'Primärversorgung für alle Altersgruppen, Präventivmedizin, Management chronischer Erkrankungen und Patientenkoordination.'},
              ...
              { name: 'Gynäkologie und Geburtshilfe', description: 'Umfassende Frauenheilkunde, Geburtshilfe, Reproduktionsmedizin und gynäkologische Onkologie.'},
              { name: 'Pädiatrie (Kinder- und Jugendmedizin)', description: 'Neonatologie, Entwicklungsneurologie, Kinderkardiologie und allgemeine Kinder- & Jugendmedizin.'},
              { name: 'Radiologie & Neuroradiologie', description: 'Diagnostische Bildgebung (CT, MRT, Röntgen, Ultraschall), interventionelle Radiologie und Neuroradiologie.'},
              { name: 'Neurologie', description: 'Schlaganfallmedizin, Epileptologie, Bewegungsstörungen und neuromuskuläre Erkrankungen.'},
              { name: 'Psychiatrie und Psychotherapie', description: 'Allgemeinpsychiatrie, Suchtmedizin, Psychotherapie und Kinder- & Jugendpsychiatrie.'},
